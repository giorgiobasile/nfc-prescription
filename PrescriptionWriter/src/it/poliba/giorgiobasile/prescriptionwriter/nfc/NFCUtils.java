...
public class NFCUtils {
	...
	public static void registerNfcMessage(Activity activity){
    	DESEncryption myEncryptor;
		try {
			myEncryptor = new DESEncryption(DESEncryption.FIRST_KEY);
            String encrypted = myEncryptor.encrypt("Prova encryption");
	...
	public static NdefMessage createNdefMessage(NdefRecord rec){
		NdefMessage msg = new NdefMessage(
    	        new NdefRecord[] {
    	            rec,
    	            NdefRecord.createApplicationRecord("it.poliba.giorgiobasile.prescriptionwriter")});
		return msg;
	}
